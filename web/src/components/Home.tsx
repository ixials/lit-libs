...
export function Home({
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-4xl items-center justify-center p-6">
      <div className="flex w-full flex-col items-center gap-8 rounded-xl border border-ll-blue bg-white p-8 sm:flex-row sm:items-center">
        <Logo />
        ...
        <div className="min-w-0 w-full flex-1">
          ...
          <div className={`${error ? "mb-3" : "mb-6"} flex items-center gap-3`}>
